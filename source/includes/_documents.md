...
To upload your data, create one Document object per item. You need to set up the collection these Documents will belong
to through the GUI first. Note the ID the new collection is assigned – this ID needs to be put into the API call.
